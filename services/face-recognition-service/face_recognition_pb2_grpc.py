...
class FaceRecognitionStub:
    ...
    def __init__(self, channel):
        ...
        self.Recognize = channel.unary_unary(
                '/vision.face.FaceRecognition/Recognize',
...
def add_FaceRecognitionServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'vision.face.FaceRecognition', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('vision.face.FaceRecognition', rpc_method_handlers)
